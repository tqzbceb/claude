...
当前版本：程序 **v1.11.7**、扩展 **v1.11.7**（程序扩展版本永远钉齐；v1.11.7 扩展只有版本号
...
4. **v1.11.7 已出包（2026-08-01），欠用户真机验收**：程序和扩展 zip 都在 `release/`（两个都是
   v1.11.7）。**换程序即可**（扩展这轮无功能改动；覆盖时别删 `dcwatch.db`）。验新东西：
